                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel class="product-thumbs-track ps-slider" :items="3" :dots="false" :nav="false">
                                    <div class="pt" v-on:click="changeImg(thumbs[0])" :class="[thumbs[0] == photo ? 'active' : '' ]">
                                        <img src="img/mickey1.jpg" alt="" />
                                    </div>

                                    <div class="pt" v-on:click="changeImg(thumbs[1])" :class="[thumbs[1] == photo ? 'active' : '' ]">
                                        <img src="img/mickey2.jpg" alt="" />
                                    </div>

                                    <div class="pt" v-on:click="changeImg(thumbs[2])" :class="[thumbs[2] == photo ? 'active' : '' ]">
                                        <img src="img/mickey3.jpg" alt="" />
                                    </div>

                                    <div class="pt" v-on:click="changeImg(thumbs[3])" :class="[thumbs[3] == photo ? 'active' : '' ]">
